...
public class PromedioGrupo{
    ...
    //declaracion variables globales
        ...
        //declaracion de un arreglo de un tda
        ...
        public static void leerAlumnos()throws IOException{
            ...
            for ( int i = 0; i < alumnos.length; i++){
                ...
                System.out.println("Escribe calificacion de igles: ");
                entrada = bufer.readLine();
        ...
        public static void imprimirAlumnos(){
            ...
            for (Alumno a : alumnos){
                System.out.println("-----------------------------------");
                System.out.println("Infromacion del alumno");
    ...
    public static void main(String[] args) throws IOException {
        ...
        //Introducir infromacion de los alumnos
        leerAlumnos();
        //Mostrae la infromacion
        imprimirAlumnos();
